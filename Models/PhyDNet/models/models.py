...
class encoder_E(nn.Module):
    def __init__(self, nc=7, nf=32):
        super(encoder_E, self).__init__()
        # input is (1) x 32 x 32
        self.c1 = dcgan_conv(nc, nf, stride=2) # (32) x 16 x 16
        self.c2 = dcgan_conv(nf, nf, stride=1) # (32) x 16 x 16
        self.c3 = dcgan_conv(nf, 2*nf, stride=2) # (64) x 8 x 8
